...
//     jQuery.ajax({
//       type: "POST",
//       url: BASE_URL + "admin/groomer_wallet_history/list/" + start + "/" + limit,
//       data: {
//         search: search,
//       },
...
//         $.ajax({
//           type: "POST",
//           url: BASE_URL + "admin/groomer_wallet_history/save",
//           data: {
//             id: $("#Id").val(),
//             title:$("#title").val(),
//             year: $("#year").val(),
...
//     jQuery.ajax({
//       type: "POST",
//       url: BASE_URL + "admin/groomer_wallet_history/view",
//       data: {
//         id: id,
//       },
//       success: function (response) {
...
//         $.ajax({
//           type: "POST",
//           url: BASE_URL + "admin/groomer_wallet_history/delete",
//           data: {
//             id: id,
//           },
//           success: function (response) {
...
//   if (data.en == "uploadProcess") {
//     data = data.data;
//     $(".updating").html(
//       "- Updating ( " + data.count + " / " + data.length + " )"
//     );
//   }
// });

// //for send data
// function sendData(en, data) {
//   var sendData = {
//     en: en,
//     data: data,
//   };
...
function pagination(start, id) {
  jQuery.ajax({
    type: "GET",
    url:
      BASE_URL +
      "admin/groomer_wallet_history" +
      "/" +
      id +
      "/" +
      start +
...
function html(list) {
  ...
  for (var i = 0; i <= list.length; i++) {
    if (i == list.length) {
      ...
      var created_at = new Date(list[i].created_at);
      let options2 = {
        day: "2-digit",
        month: "2-digit",
        year: "2-digit",
       ...
       created_at = created_at.toLocaleString("en-IN", options2).toUpperCase();
      htmlData += "<tr><td>"  + list[i].date + "</td>";
      htmlData += "<td>" + list[i].description + "</td>";
      htmlData +="<td>" + parseFloat(parseFloat(list[i].amount).toFixed(2)) + "</td>";
      htmlData +="<td>" + parseFloat(parseFloat(list[i].final_amount).toFixed(2)) +"</td>";
      htmlData += "<td>" + created_at + "</td>";
      htmlData += "<tr>";
    }
  }
}

...
function pagination(start) {
  jQuery.ajax({
    type: "GET",
    url: BASE_URL + "admin/city/list/" + start + "/" + limit + "/" + state_id,
    data: {},
...
function html(list) {
  ...
  for (var i = 0; i <= list.length; i++) {
    if (i == list.length) {
      ...
      htmlData += "<td>" + list[i].lat + "</td>";
      htmlData += "<td>" + list[i].long + "</td>";
      htmlData += "<td>";
      htmlData +=

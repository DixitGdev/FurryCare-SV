...
function pagination(start) {
  jQuery.ajax({
    type: "GET",
    url: BASE_URL + "admin/country/list/" + start + "/" + limit,
    data: {},
...
function view(id) {
  jQuery.ajax({
    type: "POST",
    url: BASE_URL + "admin/country/view",
    data: {
      id: id,
    },
    success: function (response) {
...
jQuery(document).ready(function ($) {
  ...
  $("#edit_country").on("submit", function (e) {
    e.preventDefault();
    ...
    if ($("#name").val() != "") {
      ...
      $.ajax({
        type: "POST",
        url: BASE_URL + "admin/country/save",
        data: {
          id: $("#Id").val(),
          name: $("#name").val(),
